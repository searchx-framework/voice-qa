...
window.jsPsych = (function() {
  ...
  core.init = function(options) {
    ...
    opts.display_element.innerHTML = '<div class="jspsych-content-wrapper"><header><div><img src="img/logo.svg" alt="Search" /><span class="stage">Task 2</span><ul class="right"><span class="info-need"><p id="counter"></p></span></ul></div></header><div id="jspsych-content"></div></div>';
